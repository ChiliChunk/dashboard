...
```bash
curl -s "http://127.0.0.1:8799/activities?after=0" | head -c 200
```

Doit renvoyer un tableau JSON d'activités (pas une erreur 502 — une 502
indique un problème d'identifiants ou de session Garmin expirée).
